...
public class Juego extends JFrame {
    ...
    public Juego(String nombreUsuario) {
        ...
        lblScorePlayer.setBounds(66, 32, 46, 14);
        ...
        imgPlayerPrimera.setIcon(new ImageIcon(getClass().getResource("/img/primera.png")));
        imgPlayerPrimera.setBounds(10, 57, 261, 219);
        contentPane.add(imgPlayerPrimera);

        JLabel imgPlayerPiedra = new JLabel("");
        imgPlayerPiedra.setIcon(new ImageIcon(getClass().getResource("/img/piedra.png")));
        ...
        imgPlayerPapel.setIcon(new ImageIcon(getClass().getResource("/img/Papel.png")));
        ...
        imgPlayerTijera.setIcon(new ImageIcon(getClass().getResource("/img/Tijera.png")));
        ...
        imgComputadoraPrimera.setIcon(new ImageIcon(getClass().getResource("/img/primera.png")));
        ...
        imgComputadoraPiedra.setIcon(new ImageIcon(getClass().getResource("/img/piedra.png")));
        ...
        imgComputadoraPapel.setIcon(new ImageIcon(getClass().getResource("/img/Papel.png")));
        ...
        imgComputadoraTijera.setIcon(new ImageIcon(getClass().getResource("/img/Tijera.png")));
